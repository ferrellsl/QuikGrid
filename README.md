...
If you want a binary copy of version 5.7 of QuikGrid, contact me here or at sferrellblue (at) yahoo dot com as the source and the binary for version 5.7 will not be posted here on github. Version 5.4.4 (non-LIDAR) is still available in the releases section although it's incorrectly tagged as version 5.7.
...
New hillshade graphics applied.
